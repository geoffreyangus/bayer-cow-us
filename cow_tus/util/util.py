...
def send_email(subject, message, to_addr):
    ...
    server.starttls()
    server.login("gangus.experiments", "experiments")
    ...
    msg['From'] = "gangus.experiments@gmail.com"
    msg['To'] = to_addr
    msg['Subject'] = subject
    ...
    problems = server.sendmail("gangus.experiments@gmail.com",
                               to_addr,
                               msg.as_string())
    server.quit()
